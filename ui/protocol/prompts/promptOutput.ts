...
import type { SideboardOutput } from "./sideboard";
export type PromptOutput = { type: "sideboard"; output: SideboardOutput } | { "type": "autoPass", "output": { type: "autoPass"; mode: "turnBoundary" } } | { "type": "mulligan", "output": MulliganOutput } | { "type": "mulliganPutBack", "output": MulliganPutBackOutput } | { "type": "chooseAction", "output": ChooseActionOutput } | { "type": "chooseAttackers", "output": ChooseAttackersOutput } | { "type": "chooseBlockers", "output": ChooseBlockersOutput } | { "type": "chooseBoardTargets", "output": ChooseBoardTargetsOutput } | { "type": "chooseBoolean", "output": ChooseBooleanOutput } | { "type": "chooseFromSelection", "output": ChooseFromSelectionOutput } | { "type": "revealCards", "output": RevealCardsOutput } | { "type": "scry", "output": ScryOutput } | { "type": "chooseColor", "output": ChooseColorOutput } | { "type": "chooseNumber", "output": ChooseNumberOutput } | { "type": "chooseDamageAssignmentOrder", "output": ChooseDamageAssignmentOrderOutput } | { "type": "chooseCombatDamageAssignment", "output": ChooseCombatDamageAssignmentOutput } | { "type": "payManaCost", "output": PayManaCostOutput } | { "type": "chooseCards", "output": ChooseCardsOutput } | { "type": "reorder", "output": ReorderOutput } | { "type": "diceRolled", "output": DiceRolledOutput };
