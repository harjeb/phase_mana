...
export const GAME_FORMATS: GameFormat[] = [
  ...
  },
  {
    ...
    name: "Tiny Leaders",
    shortName: "TLR",
    description: `50 cards, singleton, 20 life, legendary commander with mana value 3 or less`,
    badgeColor: "indigo",
    deckRules: {
      minDeckSize: 50,
      maxDeckSize: 50,
  ...
  },
  {
    ...
    name: "Duel Commander",
    shortName: "DUEL",
    description: `100 cards, singleton, 30 life, 1v1 commander`,
    badgeColor: "purple",
    deckRules: {
      minDeckSize: 100,
      maxDeckSize: 100,
  ...
  },
  {
    ...
    shortName: "PDH",
    description: `100 cards, singleton, 40 life, uncommon creature commander, commons only`,
    badgeColor: "sky",
    deckRules: {
      minDeckSize: 100,
      maxDeckSize: 100,
  ...
  },
  {
    ...
    name: "Momir",
    shortName: "MMR",
    description: `Momir's Madness — the engine supplies the 60-card snow-basic deck and random-creature emblem`,
    badgeColor: "blue",
    deckRules: {
      minDeckSize: 60,
      maxDeckSize: 60,
  ...
  },
  {
    ...
    name: "Old School 95",
    shortName: "O95",
    description: `Old School 93/94 plus Fourth Edition through Homelands, mana burn`,
    badgeColor: "amber",
    deckRules: {
      minDeckSize: 60,
      maxDeckSize: null,
  ...
  },
  {
    ...
    name: "Archenemy",
    shortName: "ARC",
    description: `One archenemy at 40 life against the heroes at 20, with a scheme deck`,
    badgeColor: "rose",
    deckRules: {
      minDeckSize: 60,
      maxDeckSize: null,
  ...
  },
  {
    ...
    name: "Planechase",
    shortName: "PCH",
    description: `60-card decks, 20 life, a shared planar deck and the planar die`,
    badgeColor: "blue",
    deckRules: {
      minDeckSize: 60,
      maxDeckSize: null,
