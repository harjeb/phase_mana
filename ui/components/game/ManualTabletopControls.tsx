      ...
      <div className="flex items-center justify-between gap-2 border-b px-3 py-2">
        ...
        <div className="flex items-center gap-2">
          <span className="text-[10px] text-muted-foreground">
            {t`${gameView.battlefield.length} permanents`}
          </span>
          <Button
            type="button"
            variant="ghost"
            ...
            <div key={player.id} className="rounded-md border p-2">
              ...
              <div className="mt-2 grid grid-cols-3 gap-1">
                ...
                <Button
                  ...
                  disabled={player.libraryCount <= 0}
                  title={t`Put top library card onto battlefield`}
                  onClick={() =>
                    void applyAction({
            ...
            {searchOpen && (
              <div className="absolute left-0 right-0 top-[calc(100%+0.25rem)] z-50 max-h-56 overflow-y-auto rounded-md border bg-popover p-1 shadow-lg">
                {searching && searchResults.length === 0 ? (
                  ...
                  <div className="px-2 py-1.5 text-xs text-muted-foreground">{t`No cards found`}</div>
                ) : (
              ...
              {permanents.map((card) => (
                ...
                >
                  ...
                  <Button
                    ...
                    size="icon-xs"
                    title={card.tapped ? t`Untap` : t`Tap`}
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="icon-xs"
                    title={t`Move to hand`}
                    aria-label={t`Move to hand`}
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="icon-xs"
                    title={t`Move to exile`}
                    aria-label={t`Move to exile`}
                    onClick={() =>
                      void moveCard(
                        card,
                  ...
                  <Button
                    ...
                    variant="outline"
                    size="icon-xs"
                    title={t`Move to graveyard`}
                    aria-label={t`Move to graveyard`}
                    onClick={() =>
                      void moveCard(
                        card,
