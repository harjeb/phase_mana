...
export function UpdateCallout() {
  ...
  const downloadLabel = progress == null ? t`Downloading…` : t`Downloading… ${progress}%`;
  return (
    <div className="rounded-lg border border-primary/50 bg-primary/10 p-3 motion-safe:animate-update-glow sm:flex sm:items-center sm:gap-4 sm:p-4">
      <div className="flex min-w-0 flex-1 items-center gap-2">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-xs text-muted-foreground"><Trans>Manabrew {version} is ready to install.</Trans></p>
        </div>
        <Button
          variant="ghost"
          size="icon"
      ...
      <div className="mt-2 flex items-center gap-1 sm:mt-0 sm:shrink-0">
        ...
        >
          ...
          {downloading ? downloadLabel : t`Install & restart`}
        </Button>
        <Button
          variant="ghost"
          size="icon"
