...
// Hash routing: the shell keeps its routes in the URL fragment (`#/play`,
// `#/deck-editor`, …) rather than the path, so no route of its own can be
// shadowed by a server-side path fallback and deep links survive a reload of a
